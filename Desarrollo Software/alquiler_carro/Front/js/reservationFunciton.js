...
function drawReservations(reservations) {
    ...
    for (const element of reservations) {
        tableReservations += "<tr>";
        tableReservations += "<td>" + formatDate(new Date(element.startDate),1) + "</td>";
        tableReservations += "<td>" + formatDate(new Date(element.devolutionDate),1) + "</td>";
        ...
        tableReservations += '<td><button  onclick="launchDataReservation(' + element.idReservation + ')">Lanzar</button></td>';
        tableReservations += '<td><button  onclick="putReservation(' + element.idReservation + ')">Actualizar</button></td>';
        tableReservations += '<td><button  onclick="deleteReservation(' + element.idReservation + ')">Borrar</button></td>';
        tableReservations += "</tr>";
    }
...
function launchDataReservation(idReservaton) {
    $.ajax({
        ...
        success: function (reservation) {
            ...
            $("#devolutionDate").val(formatDate(new Date(reservation.devolutionDate),2));
