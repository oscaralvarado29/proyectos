...
function drawVehicle(vehicle) {
    ...
    for (const element of vehicle) {
        ...
        tableVehicle += '<td><button onclick="launchDataVehicle(' + element.idVehicle + ')">Lanzar</button></td>';
        tableVehicle += '<td><button onclick="putVehicle(' + element.idVehicle + ')">Actualizar</button></td>';
        tableVehicle += '<td><button onclick="deleteVehicle(' + element.idVehicle + ')">Borrar</button></td>';
        tableVehicle += "</tr>";
    }
    tableVehicle += "</table>";
...
function postVehicle() {
    if ( $("#name").val()=== "" || $("#color").val()=== "" || $("#brand").val() === "" || $("#model").val()=== "" || $("#horsePower").val()=== "" || $("#engineCylinders").val()=== "" || $("#seating").val()=== "" || $("#select-category").val()=== "") {
    ...
    if ( $("#name").val()=== "" || $("#color").val()=== "" || $("#brand").val() === "" || $("#model").val()=== "" || $("#horsePower").val()=== "" || $("#engineCylinders").val()=== "" || $("#seating").val()=== "" || $("#select-category").val()=== "") {
        ...
        $.ajax({
            ...
            success: function (response) {
                cleanFieldsVehicle();
                getVehicles();
                alert("El vehiculo " + response.name + " se ha actualizado correctamente")
            },
            error: function (jqXHR, exception){
                let msgError = generalFunctions(jqXHR, exception)
                alert(msgError)
