...
function autoInicioMensajes(){
    ...
    $.ajax({
        //url:"http://132.226.242.58:8080/api/Message/all",
...
function cargarDatosMensaje(id) {
    $.ajax({
        dataType: 'json',
        //url:"http://132.226.242.58:8080/api/Message/"+id,
...
function guardarInformacionMensajes(){
    ...
    let var2 = {
        ...
        //url:"http://132.226.242.58:8080/api/Message/save",
...
function actualizarInformacionMensaje(idElemento){
    ...
    $.ajax({
        //url:"http://132.226.242.58:8080/api/Message/update",
...
function borrarMensaje(idElemento){
    ...
    $.ajax({
        //url:"http://132.226.242.58:8080/api/Message/"+idElemento,
