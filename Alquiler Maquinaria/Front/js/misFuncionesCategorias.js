...
function cargarDatosCategorias(id) {
    $.ajax({
        dataType: 'json',
        //url:"http://132.226.242.58:8080/api/Category/"+id,
...
function guardarInformacionCategorias(){
    ...
    let var2 = {
        ...
        //url:"http://132.226.242.58:8080/api/Category/save",
...
function actualizarInformacionCategorias(idElemento){
    ...
    $.ajax({
        //url:"http://132.226.242.58:8080/api/Category/update",
...
function borrarCategoria(idElemento){
    ...
    $.ajax({
        //url:"http://132.226.242.58:8080/api/Category/"+idElemento,
