...
function cargarDatosClientes(id) {
    $.ajax({
        dataType: 'json',
        url: "http://10.0.1.4:8080/api/Client/" + id,
...
function guardarInformacionCliente() {
    if ($("#Clemail").val().length == 0 || $("#Clname").val().length == 0 || $("#Clage").val().length == 0) {
        ...
        $.ajax({
            ...
            url: "http://10.0.1.4:8080/api/Client/save",
...
function actualizarInformacionCliente(idElemento) {
    if ($("#Clemail").val().length == 0 || $("#Clname").val().length == 0 || $("#Clage").val().length == 0) {
        ...
        $.ajax({
            url: "http://10.0.1.4:8080/api/Client/update",
...
function borrarCliente(idElemento) {
    ...
    $.ajax({
        url: "http://10.0.1.4:8080/api/Client/delete",
