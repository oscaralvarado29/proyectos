...
function autoInicioMensajes() {
    ...
    $.ajax({
        url: "http://10.0.1.4:8080/api/Message/all",
...
function cargarDatosMensaje(id) {
    $.ajax({
        dataType: 'json',
        url: "http://10.0.1.4:8080/api/Message/"+id,
...
function guardarInformacionMensajes() {
    if ($("#messagetext").val().length == 0 || $("#score").val().length == 0) {
        ...
        $.ajax({
            ...
            url: "http://10.0.1.4:8080/api/Message/save",
...
function actualizarInformacionMensaje(idElemento) {
    ...
    $.ajax({
        url: "http://10.0.1.4:8080/api/Message/update",
...
function borrarMensaje(idElemento) {
    ...
    $.ajax({
        url: "http://10.0.1.4:8080/api/Message/delete" ,
