...
import com.carro.pojo.ClientPojo;
import com.carro.service.ClientService;
...
public class ClientController {
    ...
    /**
     * GET for specific id
     * @param clientPojo client id to get
     * @return the call of the getClient method of the class clientService
     */
    @GetMapping("/specificId")
    public Optional<Client> getClient(@RequestBody ClientPojo clientPojo) {
