...
public class ReservationController {
    ...
    /**
     * GET for specific id
     * @param reservationPojo reservation id to get
     * @return the call of the getAll method of the class ReservationService
     */
    @GetMapping("/specificId")
    public Optional<Reservation> getReservation(@RequestBody ReservationPojo reservationPojo){
        Reservation reservation = new Reservation(reservationPojo);
        return reservationService.getReservation(reservation.getIdReservation());
    }
